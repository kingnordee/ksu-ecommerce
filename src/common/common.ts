...
export const products: IProduct[] = [
    {id: 1, name: "Chanel Perfume", price: 85.30, qty:1,
    ...
    {id: 2, name: "Backpack", price: 66.00, qty:1,
    ...
    {id: 3, name: "Camera", price: 220.00, qty:1,
    ...
    {id: 4, name: "Cleanser", price: 56.48, qty:1,
    ...
    {id: 5, name: "Running Shoe", price: 55.35, qty:1,
    ...
    {id: 6, name: "Dragon Ball Kai Wallpaper", price: 30.98, qty:1,
    ...
    {id: 7, name: "Alexa", price: 45.66, qty:1,
    ...
    {id: 8, name: "Stool", price: 30.50, qty:1,
    ...
    {id: 9, name: "Guitar", price: 150.00, qty:1,
    ...
    {id: 10, name: "Xbox Controller", price: 35.50, qty:1,
    ...
    {id: 11, name: "Keyboard", price: 87.99, qty:1,
    ...
    {id: 12, name: "Sunglasses", price: 80.99, qty:1,
